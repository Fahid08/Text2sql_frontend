...
const baseUrl = "https://uj7fyddl6oea72cu576ogfu6vu0qxhmu.lambda-url.us-east-1.on.aws/query";
            ...
            {loading ? ( // Conditionally render the loader
              ...
              <>
                <div>
                  ...
                  <div className="user-prompt mt-12">
                    <span>
                      {message.input}
                    </span>
                  </div>
          ...
          <div className="prompt-form relative">
            ...
            >
              <Input.TextArea
                ...
                className="py-8 w-[670px] input-prompt"
                onKeyDown={(e) => {
                  if (e.key === "Enter") {
                    e.preventDefault();
                    handleSubmission();
